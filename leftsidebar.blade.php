  ...
  'teammembers.team_member','teammembers.staffcode','teammembers.profilepic'
  )->first();
  $getrole = App\Models\Permission::select('page_id')->where('role_id', Auth::user()->role_id ??'')->get();
  //dd($getrole);
  @endphp
  <nav class="sidebar sidebar-bunker">
      <div class="sidebar-header" style="    background-color:#FFFFFF;">
          <!--<a href="index.html" class="logo"><span>bd</span>task</a>-->
          <a class="logo"><img src="{{ url('backEnd/image/vlogo.png')}}"
                  style="width: 215px;height:54px;" alt=""></a>
      </div>
      <!--/.sidebar header-->
          ...
          {{--    <li>
              ...
              <li>
                  ...
                  <ul class="nav-second-level">
                      ...
                      @if(Auth::user()->role_id == 11 || Auth::user()->role_id == 17 || Auth::user()->teammember_id
                      == 99 ||
                      auth()->user()->teammember_id == 161 || Auth::user()->teammember_id == 550)
                      ...
                      Auth::user()->role_id == 17 || Auth::user()->role_id == 16 || Auth::user()->role_id == 18)
              ...
              <li><a href="{{url('assetassign')}}"><i class="typcn typcn-document-text mr-2"></i> Assign Asset</a>
              </li>
              ...
              <li>
                  ...
                  <ul class="nav-second-level">
                      ...
                      @if(Auth::user()->role_id == 11 || Auth::user()->role_id == 12 || Auth::user()->teammember_id
                      == 23)
              ...
              <li><a href="{{url('conversion')}}"><i class="typcn typcn-document-delete outline mr-2"></i>
              ...
              <li>
                  ...
                  <ul class="nav-second-level">
                     <!-- <li><a href="{{url('travel')}}"> Advance Claim Form</a></li>
                      ...
                      @if(Auth::user()->role_id == 18 || Auth::user()->role_id == 11 || Auth::user()->role_id == 17
                      ||Auth::user()->teammember_id == 550 ||auth()->user()->teammember_id == 556)
                      @if(Auth::user()->teammember_id != 556 ||Auth::user()->teammember_id == 550 ||
                      auth()->user()->teammember_id == 556)
                   <!--   <li>
                          <a class="has-arrow" href="#" aria-expanded="false"> Payroll</a>
                          <ul class="nav-third-level">
                              @if(Auth::user()->teammember_id == 160 || Auth::user()->teammember_id == 173
                              ||Auth::user()->teammember_id == 550 || auth()->user()->teammember_id == 556)
                   ...
                   <!--   <li><a href="{{url('recruitmentform')}}">Recruitment Form</a></li>-->
                      ...
                      || Auth::user()->role_id == 14 || Auth::user()->role_id == 17 || Auth::user()->role_id == 15
                      || Auth::user()->role_id == 16 || Auth::user()->role_id == 12)
    ...
    @if (Auth::user()->role_id == 18 ||
          ...
          @endif
                     ...
                     <!-- <li><a href="{{url('policy')}}">Policy</a></li> -->
                      ...
                      @if(Auth::user()->role_id == 18 || Auth::user()->role_id == 11 || Auth::user()->role_id == 13 || Auth::user()->role_id == 14 || Auth::user()->role_id == 15)
                      ...
                      @endif
                      @if(Auth::user()->teammember_id == 427 || Auth::user()->role_id == 13 || Auth::user()->role_id
                      == 14 || Auth::user()->role_id == 18 || Auth::user()->role_id == 11)
...
<!--
                   ...
                   <!--   <li><a href="{{url('articlefiles')}}">Article File</a></li>-->
                    ...
                    <!--  <li><a href="{{url('neft')}}">NEFT</a></li>-->
                      ...
                      {{-- <li><a href="{{url('trainingassetsments')}}">Training Assessment
                              Form</a></li> --}}
                      @if(auth()->user()->role_id == 11 || auth()->user()->role_id == 16 || auth()->user()->role_id ==
                      17 ||
                 ...
                 <!--     <li>
                      ...
                      @endif
                      {{-- @if(Auth::user()->role_id == 13 || Auth::user()->role_id == 11 || Auth::user()->role_id == 18
                      || Auth::user()->role_id == 14 )
              ...
              <li><a href="{{url('contract')}}"><i class="typcn typcn-edit d-block mr-2"></i> Contract And
                      Subscription</a></li>
              ...
              <li>
                  ...
                  <ul class="nav-second-level">
                      <li><a href="{{url('meetingfolder')}}"><i class="typcn typcn-folder mr-2"></i>Board Meeting</a>
                      </li>
              ...
              <li><a href="{{url('connection')}}"><i class="typcn typcn-news d-block mr-2"></i>Connection</a></li>
              <li><a href="{{url('traininglist')}}"><i class="typcn typcn-pencil d-block mr-2"></i>Training
                      List</a></li>
              ...
              @php
              $ifcs = DB::table('atrs')
              ->where('responsible_person',auth()->user()->teammember_id)->first();
              @endphp
              @if($ifcs != null)
              <li><a href="{{url('atrlists')}}"><i class="typcn typcn-document-text outline mr-2"></i> ATR</a>
              </li>
              @endif
