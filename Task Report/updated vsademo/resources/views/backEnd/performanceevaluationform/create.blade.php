    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('performanceevaluationform.store')}}" enctype="multipart/form-data">
                        @csrf
...
<script>
      $(document).ready(function(){
        ...
        $(document).on('click', '#add_row', function(){
          ...
          html_code += '<td><input type="text" name="self_rating[]" id="self_rating'+count+'" data-srno="'+count+'" class="form-control" placeholder="Enter Self Rating"/></td>';
          html_code += '<td><input type="text" name="reporting_rating[]" id="reporting_rating'+count+'" data-srno="'+count+'" class="form-control" placeholder="Enter Reporting Manager Rating"/></td>';
...
<script>
      $(document).ready(function(){
        ...
        $(document).on('click', '#add_row1', function(){
          ...
          html_code += '<tr id="row_id_'+count+'">';
          html_code += '<td><span id="sr_no">'+count+'</span></td>';
          html_code += '<td><input type="text" name="development[]" id="key_responsibility'+count+'" data-srno="'+count+'" class="form-control" placeholder="Enter Development Goals/Purpose" /></td>';
          html_code += '<td><input type="text" name="priority[]" id="outcome_achievement'+count+'" data-srno="'+count+'" class="form-control" placeholder="Enter Priority"/></td>';
