...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('penality')}}">Back</a></li>
            @if(Auth::user()->teammember_id == $task->createdby)
            <li class="breadcrumb-item">
                <a href="{{url('/penality/delete/'.$task->id)}}"
                    ...
                    <div class="mailbox-sideber">
                        <div class="card-header"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="row">
                                    <h6 class="fs-17 font-weight-600 mb-0">Penalty Details </h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="mb-0 font-weight-600">Penalty.</h6>
                                </div>
                                <div class="col-auto">
							...
							<hr>
							  <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="mb-0 font-weight-600">Amount.</h6>
                                </div>
                                <div class="col-auto">
                                    <time class="fs-13 font-weight-600 text-muted" datetime="1988-10-24">
                                        <td>{{ $task->amount ??'' }}</td>
            ...
            <div class="inbox-mail-details p-3">
                <div class="row">
                    <div class="card" style="width: 100%;box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2)">
                        ...
                        <div class="mt-3 p-3">
                            <form method="post" action="{{ url('penality/update')}}" enctype="multipart/form-data">
                                @csrf
