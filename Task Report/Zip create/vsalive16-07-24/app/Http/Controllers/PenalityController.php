...
class PenalityController extends Controller
{
    ...
    {
        return view('backEnd.penality.statusindex'); 
    }
	 public function list($id)
  {
    ...
    //   dd($taskDatas);
        return view('backEnd.penality.index',compact('taskDatas'));
    }
   ...
   //  dd($taskDatas);
    ...
    // dd($taskassignDatas);
      ...
      return view('backEnd.penality.taskassemble',compact('taskDatas','taskassignDatas'));
    }
    }
    ...
    public function create()
    {
        ...
        return view('backEnd.penality.create',compact('teammember'));
    }
    ...
    public function store(Request $request)
     ...
     $data=$request->except(['_token']);
           ...
           Mail::send('emails.penalityassign', $data, function ($msg) use($data, $teammember){
                $msg->to($teammember);
                $msg->subject('kgs New Penality Assign');
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.penality.edit', compact('id', 'task','title','teamrole','teammember','taskassign'));
    }
...
'authnames' =>  $authname->team_member,
     ...
     Mail::send('emails.penalityassigns', $data, function ($msg) use($data, $teammember){
         $msg->to($teammember);
         $msg->subject('kgs New Penality Instruction');
      });
     }
    }
    if(auth()->user()->teammember_id != $tasks->createdby){
...
$msg->subject('kgs New Penality Instruction');
    ...
    public function viewTask($id)
   {
      ...
      // dd($viewinfo);
        return view('backEnd.penality.view', compact('id', 'task','tasktrails'));
    }
 ...
 public function resetPassword($id)
    {
       // dd($id);
        $task = task::where('id', $id)->first();
        return view('backEnd.penality.resetpassword', compact('id', 'task'));
    }
   ...
   public function update(Request $request, $id)
    {
        ...
        try {
         ...
         Mail::send('emails.penalityassign', $data, function ($msg) use($data, $teammember){
             $msg->to($teammember);
             $msg->subject('kgs Penality Assign');
          });
         }
            $output = array('msg' => 'Updated Successfully');
            return redirect('task')->with('success', $output);
