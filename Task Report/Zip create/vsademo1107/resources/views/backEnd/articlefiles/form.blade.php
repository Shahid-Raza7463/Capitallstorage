...
<div class="row row-sm">
  <div class="col-3">
        <div class="form-group">
            ...
            <input type="text" required  name="fathersname" value="{{ $articlefiles->fathersname ?? ''}}" class="form-control"
  ...
  <div class="col-3">
        <div class="form-group">
            ...
            <input type="text" required  name="mothersname" value="{{ $articlefiles->mothersname ?? ''}}" class="form-control"
    ...
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="date" required  name="dob" value="{{ $articlefiles->dob ?? ''}}" class="form-control"
    ...
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="date" required  name="doj" value="{{ $articlefiles->doj ?? ''}}" class="form-control"
...
<div class="row row-sm">
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="number" required  name="emergencycontactnumber" value="{{ $articlefiles->emergencycontactnumber ?? ''}}" class="form-control"
    ...
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="number" required  name="emergencycontactnumbertwo" value="{{ $articlefiles->emergencycontactnumbertwo ?? ''}}" class="form-control"
...
<div class="row row-sm">
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="file"  required name="document10th" value="{{ $articlefiles->document10th ?? ''}}" class="form-control"
  ...
  <div class="col-4">
    <div class="form-group">
        ...
        <input type="file" required  name="document12th" value="{{ $articlefiles->document12th ?? ''}}" class="form-control"
            placeholder="Enter Financial Year .">
    </div>
    </div>
    <div class="col-4">
        <div class="form-group">
            ...
            <select name="documentbcom" required id="documentbcom" class="form-control">
                <!--placeholder-->
    ...
    <div class="col-3">
      ...
      <div class="col-3">
          <div class="form-group">
              ...
              <input type="file" required name="octrainingcertificate" value="{{ $articlefiles->octrainingcertificate ?? ''}}" class="form-control"
                  placeholder="Enter Financial Year .">
          </div>
      </div>
  ...
  <div class="row row-sm">
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="file" required name="itttrainingcertificate" value="{{ $articlefiles->itttrainingcertificate ?? ''}}" class="form-control"
      ...
      <div class="col-3">
          <div class="form-group">
              ...
              <input type="file" required  name="residenceproof" value="{{ $articlefiles->residenceproof ?? ''}}" class="form-control"
                  placeholder="Enter Period of Appointment .">
          </div>
          </div>
      <div class="col-3">
          <div class="form-group">
              ...
              <input type="file" required name="residenceprooftwo" value="{{ $articlefiles->residenceprooftwo ?? ''}}" class="form-control"
                  placeholder="Enter Period of Appointment .">
          </div>
          </div>
          <div class="col-3">
  ...
  <div class="row row-sm">
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="file" required name="photograph" value="{{ $articlefiles->photograph ?? ''}}" class="form-control"
                placeholder="Enter Financial Year .">
        </div>
    </div>
    <div class="col-3">
  ...
  <div class="row row-sm">
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" required  name="accountholder" value="{{ $articlefiles->accountholder ?? ''}}" class="form-control"
      ...
      <div class="col-4">
          <div class="form-group">
              ...
              <input type="text" required  name="accountname" value="{{ $articlefiles->accountname ?? ''}}" class="form-control"
      ...
      <div class="col-4">
          <div class="form-group">
              ...
              <input type="text" required  name="accountnumber" value="{{ $articlefiles->accountnumber ?? ''}}" class="form-control"
          ...
          <div class="col-4">
            <div class="form-group">
                ...
                <input type="text" required  name="ifsccode" value="{{ $articlefiles->ifsccode ?? ''}}" class="form-control"
      ...
      <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" required  name="branch" value="{{ $articlefiles->branch ?? ''}}" class="form-control"
                placeholder="Enter Branch .">
        </div>
    </div>
  </div>
