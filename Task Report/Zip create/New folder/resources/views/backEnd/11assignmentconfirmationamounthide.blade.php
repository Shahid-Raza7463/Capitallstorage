                    ...
                    data-target="#exampleModal12">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content " style="border-radius: 3rem;">
                                ...
                                <form id="detailsForm" method="post" action="{{ url('assignmentconfirmationotphide') }}"
                                                    ...
                                                    <div name="otp"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="position-relative">
                                                                <div id="otp"
                                                                    class="inputs d-flex flex-row justify-content-center mt-2">
                                                                    <input required name="otp11"
                                                                        class="m-2 text-center form-control rounded"
                                                                        type="number" id="first"
                                                                        maxlength="1" />
                                                                    <input required name="otp12"
                                                                        class="m-2 text-center form-control rounded"
                                                                        type="number" id="second"
                                                                        maxlength="1" />
                                                                    <input required name="otp13"
                                                                        class="m-2 text-center form-control rounded"
                                                                        type="number" id="third"
                                                                        maxlength="1" />
                                                                    <input required name="otp14"
                                                                        class="m-2 text-center form-control rounded"
                                                                        type="number" id="fourth"
                                                                        maxlength="1" />
                                                                    <input required name="otp15"
                                                                        class="m-2 text-center form-control rounded"
                                                                        type="number" id="fifth"
                                                                        maxlength="1" />
                                                                    <input required name="otp16"
                                                                        class="m-2 text-center form-control rounded"
                                                                        type="number" id="sixth"
                                                                        maxlength="1" />
                                                                </div>
                                                        ...
                                                        <div style="width: 332px; text-align: center" class="resends"><span
                                                                ...
                                                                receive the OTP?</span><span
                                                                style="color: rgba(41, 45, 50, 0.85); font-size: 16px; font-family: Inter; font-weight: 500; word-wrap: break-word">
                                                                <a id="noid" data-id="{{ $debtorid }}" data-status="0" data-resend="true" class="font-weight-500" style="color:#37a000;"> Resend</a>
                                                            </span>
                                                        </div>
                                                    </div>
