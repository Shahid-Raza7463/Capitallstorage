                  ...
                  <div class="card mb-4">
                      <div class="card-header" style="background: #37A000">
                          <div class="d-flex justify-content-between align-items-center">
                              <div>
                                  <h6 style="color:white;" class="fs-17 font-weight-600 mb-0">Edit Assignment Budgeting
                                  </h6>
                              </div>
                          </div>
                      </div>
                              ...
                              <div class="row row-sm">
                                  <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <option value="2">Half Yearly</option>
                                        <option value="1">Quarterly</option>
                                        <option value="0">Monthly</option> @endif
                                              @endif
                                          </select>
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-4">
                                      <div class="form-group">
                                          ...
                                          <input type="date" id="example-date-input" name="duedate"
                                              value="{{ $assignmentbudgeting->duedate ?? '' }}"
                                              class=" form-control leaveDate" placeholder="Enter Date">
                                      </div>
                                  </div>
                                  <div class="col-4">
                                      <div class="form-group">
                                          ...
                                          <input type="date" id="example-date-input" name="draftreportdate"
                                              value="{{ $assignmentbudgeting->draftreportdate ?? '' }}"
                                              class="form-control leaveDate" placeholder="Enter Billing Amount">
                                      </div>
                                  </div>
                                  <div class="col-4">
                                      <div class="form-group">
                                          ...
                                          <input type="date" id="example-date-input" name="billdate"
                                              value="{{ $assignmentbudgeting->billdate ?? '' }}"
                                              class=" form-control leaveDate" placeholder="Enter Date">
                                      </div>
                                  </div>
                              </div>
                                  ...
                                  <div class="col-6">
                                      <div class="form-group">
                                          ...
                                          <input type="date" id="example-date-input" name="finalreportdate"
                                              value="{{ $assignmentbudgeting->finalreportdate ?? '' }}"
                                              class=" form-control leaveDate" placeholder="Enter Date">
                                      </div>
                                  </div>
                                  <div class="col-6">
                                      <div class="form-group">
                                          ...
                                          <input type="date" id="example-date-input" name="moneyreceiveddate"
                                              value="{{ $assignmentbudgeting->moneyreceiveddate ?? '' }}"
                                              class=" form-control leaveDate" placeholder="Enter Date">
                                      </div>
                                  </div>
                              </div>
