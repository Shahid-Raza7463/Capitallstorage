        ...
        <div class="form-container my-4" >
            ...
            <div class="panel">
             ...
             <div class="register-logo text-center mb-4">
                <img src="{{ url('backEnd/image/capitallinternal.png')}}" style="width: 50%;" alt="">
            </div><br>
                <form  method="POST" action="{{url('authnewpassowrd/store/'.$id)}}">
                    ...
                    <div class="form-group">
                        <input type="password" name="password_confirmation" class="form-control @error('email') is-invalid @enderror" required placeholder="Enter Confirm Password" >
