...
<div class="content-header row align-items-center m-0">
    ...
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('dataanalytics/create')}}">Add Data Analytics Query</a></li>
        ...
        <div class="media">
            ...
            <div class="media-body">
               <a href="{{url('home')}}"> <h1 class="font-weight-bold" style="color:black;">Home</h1></a>
                <small>Data Analytics Query List</small>
            </div>
        </div>
    </div>
</div>
...
<div class="body-content">
  ...
  <td><a href="{{url('view/dataanalytics', $taskData->id)}}" >{{$taskData->taskname ??''}}</a></td>
