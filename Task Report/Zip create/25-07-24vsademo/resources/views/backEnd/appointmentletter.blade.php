                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p
                                    ...
                                    <span style='font-size:13px;font-family:"Arial","sans-serif";'>Name: {{ $teammember->team_member }}</span></p>
                                ...
                                <p
                                    ...
                                    <span style='font-size:13px;font-family:"Arial","sans-serif";'>Permanent Address : {{ $teammember->permanentaddress }}</span></p>
                                <p
                                    style='margin-right:-3.15pt;margin-left:0in;font-size:16px;font-family:"Times New Roman","serif";margin:0in;margin-bottom:.0001pt;'>
                                    <span style='font-size:13px;font-family:"Arial","sans-serif";'>Communication Address : {{ $teammember->communicationaddress }}</span></p>
                                <p
                            ...
                            <div class="col-sm-12">
                                <p
                                    ...
                                    <strong><span
                                            ...
                                            style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'><span
                                              >{{ $teammember->designation }}</span></span></strong></p>
                                <p
                            ...
                            <div class="col-sm-12">
                                ...
                                <p
                                    ...
                                    <span
                                        ...
                                        are pleased to offer you, the position of<strong>&nbsp;<span>{{ $teammember->designation }}</span></strong></span><strong><span
                                    ...
                                    <ol style="margin-bottom:0in;list-style-type: undefined;margin-left:-0.25in;">
                                        ...
                                        <p
                                            ...
                                            <span style='font-size:13px;font-family:"Arial","sans-serif";'>1.1 &nbsp;
                                                &nbsp;Your
                                                employment will be effective as of <strong><span >{{ date('d-F-Y', strtotime($teammember->employeeeffectivedate)) }}</span></strong></span>
                                        </p>
                                        <p
                                            style='margin-right:0in;margin-left:0in;font-size:16px;font-family:"Times New Roman","serif";margin:0in;margin-bottom:.0001pt;text-indent:34.15pt;'>
                                            <strong><span
                                                    style='font-size:13px;font-family:"Arial","sans-serif";background:yellow;'>&nbsp;</span></strong>
                                        </p>
                                        <p
                                        ...
                                        <p
                                            ...
                                            <span style='font-size:13px;font-family:"Arial","sans-serif";'>4.1 Your
                                                total Cost
                                                to the Company will be <strong>Rs. <span>{{ $teammember->salary }}</span>/- per
...
<br>
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        7.1 You will be governed by the Policies of the company as may be applicable to
                                ...
                                <p
                                    ...
                                    <span
                                        ...
                                        neglect of duty, or incompetence in the discharge of duty on your part of the
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        8.1 You will always maintain in good condition Company property, which may be
                                        entrusted to you for official use
                                        during your employment. Upon the termination of your employment for any reason,
                                        On your last working day, you
                                        will return to the Company all Company documents (and all copies thereof) and
                                        ...
                                        phones, wireless electronic mail devices or other equipment, or documents and
                                        property belonging to the
                                        Company, Identity Cards, Visiting Cards, Credit Cards, Company files, notes,
                                        financial and operational
                                        information, client/customer lists and contact information, product and services
                                        information,
                                    </span>
                                </p><br>
                                <p
                                ...
                                <p
                                    ...
                                    <span
                                        ...
                                        review, prepare or transmit any confidential or proprietary data, materials or
                                        ...
                                        information and permanently delete and expunge such confidential or proprietary
...
<br>
                                <p
                                    ...
                                    <span
                                        ...
                                        the company asset as per the above mentioned clause 8.1 &amp; 8.2, Company shall
                            ...
                            <div class="footerr">
                                ...
                                <div style="text-align:center; font-size:14px;" class="text-success m-b-15"><span
                                        ...
                                        <br> Corp Office: 4/1 Asaf Ali Road, 3rd Floor, Delite Cinema Building, Delhi
                        ...
                        <div class="col-sm-12">
                            <div
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        9.1 You must always maintain the highest degree of confidentiality and keep as
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        9.2 Confidential Information’ means information about the Company’s business and
                                        that of its customers/clients which is not available to the general public and
                                        ...
                                        products, processes including ideas, concepts, projections, technology, manuals,
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        9.5 Breach of the conditions of this clause will render you liable to summary
                                ...
                                <p
                                    ...
                                    <span
                                        ...
                                        during or after termination may result in your employment termination and/or the
                                        initiation of legal proceedings against you. you will be personally liable to
                                ...
                                <p
                                    ...
                                    <span
                                        ...
                                        information regardless of media on which it is stored (paper, computer, videos,
                                        recorders etc) or personal information, transmitted
                                        through any source, electronic media, face to face conversation, internet or any
                                        additional system software, is considered to be sensitive and confidential. You
                                        understand that access to this information is to a legitimate, “need to know”
                                        basis and is restricted to information directly related to your assigned duties
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        10.3. Some information disclosed or acquired by reason of your employment may be
                                        confidential and you agree not to disclose any confidential information, data,
                                        or access or security codes, passwords, anytime , except for a “need to know”
                                        ...
                                        You will be responsible for the data you retrieve, and ultimately for documents
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        10.4. Company laptops/Desktops are to be used only for the authorized purposes
                                        only. You understand that you are to restrict data retrieval and other computing
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        10.5. You understand and agree that it is your duty to maintain confidentiality
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        10.6. When in doubt, you will confer with concerned personal or the supervisor.
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        10.7. Failure to abide by the rules may result in data access being discontinued
                                        and/or disciplinary action, up to and including termination of employment and
...
<br>
                                ...
                                <p
                                    ...
                                    <span
                                        ...
                                        Formalities and sign necessary forms in this regard, as per the policy of the
                                        firm,
                                    </span>
                                </p><br>
                                <p
...
<br>
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        You as an employee explicitly agree that your full and final settlement of dues
                                        shall happen within 30-45 days of the completion of aforesaid formalities and
                                        first adjusting all dues under whatsoever head them due to the company. In case
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        As an employee of the firm, you are required to book proper time and expense.
                                        Use only the official Email ID provided by the firm, not share your access card
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        It is also mandatory to keep the HR informed about any changes in your personal
                                        particulars or documents, address change, updated adhaar or pan card, Driving
                                        license etc.
                                    </span>
                                </p>
                                <p
                                ...
                                <p
                                    ...
                                    <span
                                        ...
                                        existing now and which may be amended from time to time will be applicable to
                                ...
                                <p
                                    ...
                                    <span
                                        style='font-size:13px;line-height:150%;font-family:"Arial","sans-serif";color:windowtext;'>
                                        We are delighted to have you in the company. Please indicate your understanding
                                        and acceptance of the above terms and conditions by signing and returning the
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <p
                                            style='margin-right:0in;margin-left:0in;font-size:16px;font-family:"Times New Roman","serif";margin:0in;margin-bottom:.0001pt;background:white;'>
                                            &nbsp;</p>
                                            <img class="logo" src="{{ url('backEnd/priyanka.jpg')}}" style="width: 211px;" alt="">
                                        <p style="margin-left:10%;"><span
                                                style='font-size:13px;font-family:"Arial","sans-serif";'>Human Resource
                                        </p>
                                        <p style="margin-left:10%;"><span
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p style="margin-left:30%;">Name of Employee : <b>{{ $teammember->team_member }}</b></span></p>
                                        <p style="margin-left:30%;">Signature @if($teammember->status == 0)___________________________ @else <b>E-Verified through CapITall by {{ $teammember->team_member }} on {{ date('F d,Y', strtotime($teammember->otpdate)) }}</b> @endif</span></p>
                                    </div>
                                </div>
                                <br><br>
                                <br><br>
...
//dd($authid);
                    @endphp
                    <a style="color: white" id="editCompany" data-id="{{ $authid }}" data-toggle="modal" class="btn btn-success" data-target="#exampleModal1">Acknowledge</a>
                </div>
                <div class="col-sm-5">
                </div>
            </div>
        ...
        <div class="modal-content">
            <form id="detailsForm" method="post" action="{{ url('otpap/store')}}" enctype="multipart/form-data">
                ...
                <div class="modal-header" style="background: #37A000">
                    <h5 style="color:white;" class="modal-title font-weight-600" id="exampleModalLabel4">Enter Verification OTP</h5>
                    <div>
                        <ul>
