                        ...
                        <table class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $articleship->mrn_nro_cro_wro}}</td>
                                    <td><b>Name : </b></td>
                                ...
                                <tr>
                                    ...
                                    <td><b>Resume : </b></td>
                                    <td><a target='blank'
                                            href="{{'backEnd/documents/directapplications/'.$articleship->resume ??'' }}">{{   str_ireplace('backEnd/documents/directapplications/','',$articleship->resume) ??'' }}
                                    </td>
                                    <td><b>Remarks : </b></td>
