<div class="row row-sm">
    ...
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="text" @if (Request::is('client/*/edit')) @if ($clientcheck != null) readonly @endif
                @endif name="client_name" id="client_name" required
            value="{{ $client->client_name ?? '' }}" class="form-control"
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <option value="14">HUF</option>
               ...
               <option value="5">Private Limited Company</option>
               <option value="8">Society</option>
               <option value="9">Trust</option> @endif
            @else <option>Please Select One</option>
                <option value="2">Individual</option>
                <option value="3">Proprietorship</option>
                <option value="4">Firm</option>
                <option value="5">Private Limited Company</option>
...
<div class="row row-sm">
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input required type="text" id="pan_number" name="panno" value="{{ $client->panno ?? '' }}"
                class="form-control" placeholder="Enter Pan Card No">
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="tanno" name="tanno" value="{{ $client->tanno ?? '' }}"
                class="form-control" placeholder="Enter Tan No">
        </div>
    </div>
    <div class="col-4">
        <div class="form-group">
            <label class="font-weight-600">GST No *</label>
            <input required type="text" id="gstno" name="gstno" value="{{ $client->gstno ?? '' }}"
...
<div class="row row-sm">
    ...
    <div class="col-4" id='otherclassification' style="display: none;">
        <div class="form-group">
            ...
            <input type="text" name="otherclassification" value="{{ $client->otherclassification ?? '' }}"
        ...
        $(".clientAddForm").submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (!data.success) {
                        var duplicateClientName = data.duplicateClientName;
                        errorMessageSpan.text("PAN number is a duplicate for client: " +
                            duplicateClientName);
                        return false; // Prevent form submisssion
                    } else {
                        if (panNumber === prevPanNumber) {
                            errorMessageSpan.text(
                                "PAN number is the same as the previously entered PAN number"
                            );
