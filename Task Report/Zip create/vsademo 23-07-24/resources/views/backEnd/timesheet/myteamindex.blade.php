                          ...
                          <tbody>
                              @foreach ($get_date as $jobDatas)
                                  <tr>
                                      <td>
                                          <a
                                              href="{{ url('/weeklylist?id=' . $jobDatas->id . '&&teamid=' . $jobDatas->teamid . '&&partnerid=' . $jobDatas->partnerid . '&&startdate=' . $jobDatas->startdate . '&&enddate=' . $jobDatas->enddate) }}">
                                              {{ $jobDatas->team_member }}
                                          </a>
                                      </td>
                                      ...
                                      <td>{{ Auth::user()->role_id == 11 && isset($jobDatas->dayscount) && $jobDatas->dayscount != 0 ? $jobDatas->dayscount : $jobDatas->totaldays }}
                                      </td>
