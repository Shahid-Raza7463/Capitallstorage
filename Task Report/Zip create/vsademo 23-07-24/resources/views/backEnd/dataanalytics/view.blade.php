...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('dataanalytics')}}">Back</a></li>
			{{-- @if(Auth::user()->role_id == 11 || Auth::user()->teammember_id == $task->createdby)
			  <li class="breadcrumb-item"><a href="{{url('secretaryoftask/'. $task->id.'/edit')}}">Edit</a></li>
			@endif --}}
        </ol>
    </nav>
        ...
        <div class="mailbox-body">
                    ...
                    <div class="mailbox-sideber">
                        <div class="card-header"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="row">
                                    <h6 class="fs-17 font-weight-600 mb-0">Query Details </h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="mb-0 font-weight-600">Name of Query</h6>
                                </div>
                                <div class="col-auto">
            ...
            <div class="inbox-mail-details p-3">
                <div class="row">
                        ...
                        <div class="inbox-avatar-wrap p-3 border-btm d-sm-flex">
                            <div class="inbox-avatar-text ml-sm-3 mb-2 mb-sm-0">
                                <div class="avatar-name">
                                    ...
                                    <b style="font-size: 15px;">{{ App\Models\Teammember::select('team_member')->where('id',$task->createdby)->first()->team_member ?? ''}}</b>
                                </div>   <br>
                  ...
                  ->where('task_attachments.taskid',$task->id)->get();
               // dd($sectaskData);
                         @endphp
                         ...
                         @if(count($sectaskData) != 0)
                                <h5> <i class="fa fa-paperclip"></i> Attachments </h5>
                                 ...
                                 href="{{url('backEnd/image/secretarialtask/'.$sectaskDatas->file)}}"><img style="max-width: 180%;"
                      ...
                      ->where('task_attachments.tasktrailsid',$tasktrailsData->id)->get();
                   // dd($sectaskk);
                             @endphp
                       ...
                       @endforeach
                        ...
                        <div class="mt-3 p-3">
                            <form method="post" action="{{ url('dataanalytics/update')}}"
                                enctype="multipart/form-data">
                                @csrf
                                @if($task->status == 0)
                                <p><textarea required class="centered form-control"
                                        rows="3" name="remark" value="" placeholder=""></textarea><br>
                                        @endif     
                                    <div class="row">
                                    @if($task->status == 0)
                                        <div class="col-4">
