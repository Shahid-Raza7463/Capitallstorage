...
<div class="row row-sm">
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="date" required id="example-date-input" name="dateofbirth"
                value="{{ $teammember->dateofbirth ?? '' }}" class="form-control leaveDate"
        ...
        @if (Request::is('teammember/*/edit'))
            <div class="form-group">
                ...
                <a href="{{ $teammember->addressupload }}" target="blank" data-toggle="tooltip"
                    title="{{ $teammember->addressupload ?? '' }}" class="btn btn-success-soft ml-2"><i
            ...
            @if ($teammember->panupload != null)
                <div class="form-group">
                    ...
                    <a href="{{ $teammember->panupload }}" target="blank" data-toggle="tooltip"
                        title="{{ $teammember->panupload ?? '' }}" class="btn btn-success-soft ml-2"><i
                            class="fas fa-file"></i> View</a>
                </div>
            @endif
        @endif
        ...
        @if (Request::is('teammember/*/edit'))
            @if ($teammember->appointment_letter != null)
                <div class="form-group">
                    ...
                    <a href="{{ url('backEnd/image/teammember/appointmentletter/', $teammember->appointment_letter) }}"
...
<div class="row row-sm">
    ...
    <div class="col-2">
        <div class="form-group">
            ...
            <input type="file" name="cancelcheque" class="form-control" placeholder="Enter Permanent Address">
        </div>
    </div>
    <div class="col-2">
        @if (Request::is('teammember/*/edit'))
            @if ($teammember->cancelcheque != null)
                <div class="form-group">
                    ...
                    <a href="{{ url('backEnd/image/teammember/cancelcheque/' . $teammember->cancelcheque) }}"
                        target="blank" data-toggle="tooltip" title="{{ $teammember->cancelcheque ?? '' }}"
                        class="btn btn-success-soft ml-2"><i class="fas fa-file"></i> View</a>
                </div>
            @endif
        @endif
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="date" required id="example-date-input" name="joining_date"
                value="{{ $teammember->joining_date ?? '' }}" class="form-control leaveDate"
                placeholder="Enter joining_date">
        </div>
    </div>
    {{-- @if (isset($teammember->old_leavingdate))
        <div class="col-4">
            <div class="form-group">
                <label class="font-weight-600">Old Leaving Date</label>
                <input type="date" id="example-date-input" name="old_leavingdate"
                    value="{{ $teammember->old_leavingdate ?? '' }}" class="form-control leaveDate"
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="date" id="example-date-input" name="dateofresign"
                value="{{ $teammember->dateofresign ?? '' }}" class="form-control leaveDate"
