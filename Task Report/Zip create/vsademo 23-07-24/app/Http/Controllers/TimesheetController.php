...
class TimesheetController extends Controller
{
  ...
  //     ->leftjoin('teammembers as partners', 'partners.id', 'timesheetreport.partnerid')
  //     // ->where('timesheetreport.teamid', auth()->user()->teammember_id)
  //     ->select('timesheetreport.*', 'teamrolehistory.newstaff_code', 'teammembers.team_member', 'teammembers.staffcode', 'partners.team_member as partnername', 'teammembers.emailid')
  //     ->latest()
  //     ->get();
  ...
  //     ->select('assignmentmappings.id', 'teamrolehistory.newstaff_code', 'teammembers.id as teamid', 'teammembers.team_member', 'teammembers.role_id', 'teammembers.staffcode', 'titles.title', 'assignmentmappings.assignmentgenerate_id', 'assignmentbudgetings.assignmentname', 'assignmentteammappings.teamhour')
  //     // ->take(10)
  //     ->get();
  ...
  // isme problem hai jab vishal agerwal ko partner bnaya hu tab 
  public function assignmentHourShowfilter(Request $request)
  {
  ...
  //         return response()->json(['success' => true, 'msg' => 'Request Successfully']);
  //       } else {
  //         $msg = 'You can submit new timesheet request after 24 hour from ' . date('h-m-s', strtotime($latestrequest->created_at));
  //         return response()->json(['success' => false, 'msg' => $msg]);
  //       }
  //     } else {
  //       $fileName = '';
