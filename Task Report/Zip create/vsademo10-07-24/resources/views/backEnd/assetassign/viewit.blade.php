                       ...
                       <div class="row row-sm">
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input required type="number" id="example-date-input" name="amount" value="" class="form-control"
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <select required class="form-control" name="teammember_id"
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="example-date-input" name="vendor" required class="form-control"
                                    placeholder="Enter Vendor Name">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    <label class="font-weight-600">Refrence No. *</label>
                                    <input required type="text" id="example-date-input" name="refrence" required class="form-control"
                                    placeholder="Enter Refrence No">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    <label class="font-weight-600">Bill Upload. *</label>
                                    <input required type="file" id="example-date-input" name="bill" required class="form-control"
                                    placeholder="Enter Refrence No">
                                </div>
                            </div>
                       </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{ $assetlog->amount ??''}}</td>
							   <td>{{ $assetlog->vendor ??''}}</td>
							   <td>{{ $assetlog->refrence ??''}}</td>
							   <td> <a  href="{{ Storage::disk('s3')->temporaryUrl('assetbill/'.$assetlog->bill, now()->addMinutes(3)) }}"
                                                    target="blank">{{ $assetlog->bill ??''}}</a></td>
