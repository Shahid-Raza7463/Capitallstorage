  ...
  @extends('backEnd.layouts.layout') @section('backEnd_content')
      ...
      <div class="modal modal-success fade exampleModal155-modal-lg" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog modal-lg">
              <div class="modal-content">
                  <form id="detailsForm1" method="post" action="{{ url('assignmentconfirmation/mail') }}"
                      enctype="multipart/form-data">
                      @csrf
                      <div class="modal-header">
      ...
      <div class="modal modal-success fade exampleModal1556-modal-lg" tabindex="-1" role="dialog"
          aria-labelledby="exampleModalLabel3" aria-hidden="true">
          <div class="modal-dialog modal-lg">
              <div class="modal-content" style="width: fit-content;right: 25px;">
    ...
    @endforeach
      ...
      <script>
          function saveForm() {
              document.getElementById('detailsForm1').action = "{{ url('/assignmentmaildraft') }}";
          }

          function saveForm2() {
              document.getElementById('detailsForm1').action = "{{ url('/assignmentfinalsave') }}";
          }
      </script>
