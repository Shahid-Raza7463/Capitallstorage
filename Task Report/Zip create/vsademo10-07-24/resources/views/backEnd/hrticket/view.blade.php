                            ...
                            <div class="card" style="width: 100%;box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2)">
                                            ...
                                            <div class="col-3 col-lg-2">
                                                <a target="blank" target="blank" data-toggle="tooltip"
                                                    ...
                                                    href="{{url('backEnd/image/secretarialtask/'.$sectaskDatas->file)}}"><img
                                                        style="max-width: 180%;" class="img-thumbnail img-responsive"
                                                        alt="attachment" src="{{url('/backEnd/documents.png')}}">
                                                </a>
                                            </div>
                                ...
                                <div class="mt-3 p-3">
                                    <form method="post" action="{{ url('hrticket/update')}}"
                                        ...
                                        @csrf
                                        @if($task->status == 0)
                                        <p><textarea required class="centered form-control" rows="3" name="remark"
                                                value="" placeholder=""></textarea><br>
                                            @endif
                                            <div class="row">
                                                @if($task->status == 0)
                                                <div class="col-4">
