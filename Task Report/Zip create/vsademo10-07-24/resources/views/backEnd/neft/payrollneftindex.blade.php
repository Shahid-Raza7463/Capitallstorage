    ...
    <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
        <li class="breadcrumb-item"> <div class="btn-group mb-2 mr-1">
            ...
            <div class="dropdown-menu">
                ...
                href="{{url('/payrollarticleneftss?'.'month='.'February')}}">February</a>
				 <a style="color: #37A000" class="dropdown-item"
                href="{{url('/payrollarticleneftss?'.'month='.'January')}}">January</a>
				 <a style="color: #37A000" class="dropdown-item"
                href="{{url('/payrollarticleneftss?'.'month='.'December')}}">December</a>
				 <a style="color: #37A000" class="dropdown-item"
                href="{{url('/payrollarticleneftss?'.'month='.'November')}}">November</a>
                <a style="color: #37A000" class="dropdown-item"
