                        ...
                        <div class="card-body p-md-5">
                            ...
                            <form method="POST" action="{{ url('candidateonboarding/store') }}"
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="membershipnumber"
                                                placeholder="Enter Membership Number" class="form-control"
                                                value="" />
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-4" id="pfform" style="display: none">
                                        <div class="form-group">
                                    ...
                                    <div class="col-4" id="pfformupload" style="display: none">
                                        <div class="form-group">
                                            <label class="font-weight-600"> PF Form 11.*</label><br>
                                    ...
                                    <div class="col-4" id="uan" style="display: none">
                                        <div class="form-group">
                                    ...
                                    <div class="col-4" id="out" style="display: none">
                                        <div class="form-group">
                                    ...
                                    <div class="col-4" id="outupload" style="display: none">
                                        <div class="form-group">
                                            <label class="font-weight-600"> Opt Out - PF Declaration </label><br>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required name="adharcardno" id="aadhar"
                                                ...
                                                class="form-control" placeholder="Enter Adhar No" value="">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
