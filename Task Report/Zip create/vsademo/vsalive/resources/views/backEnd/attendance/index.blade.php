        ...
        <div class="card-body">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                        aria-controls="pills-home" aria-selected="true">CA Article</a>
                </li>


                <li class="nav-item">
                    <a class="nav-link" id="pills-user-tab" data-toggle="pill" href="#pills-user" role="tab"
                        aria-controls="pills-user" aria-selected="false">Employee</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-intern-tab" data-toggle="pill" href="#pills-intern" role="tab"
                        aria-controls="pills-intern" aria-selected="false">Intern</a>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                    ...
                    <div class="table-responsive">
                        <table id="examples" class="display nowrap">
                            <thead>
                                <tr>
                                    <th style="display: none;">id</th>
                                    <th>Employee Name</th>
                            ...
                            <tbody>
                                @foreach($attendanceDatass as $attendanceData)
                                <tr data-toggle="modal" data-target="#updateModal{{$attendanceData->id}}">
                                    <td style="display: none;">{{$attendanceData->id }}</td>
                                    <td>{{ $attendanceData->team_member }}</td>
									<td>{{ $attendanceData->rolename }}</td>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="one">One:</label>
                                                                <input type="text" name="one" id="one" class="form-control" value="{{ $attendanceData->one ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="two">Two:</label>
                                                                <input type="text" name="two" id="two" class="form-control" value="{{ $attendanceData->two ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="three">Three:</label>
                                                                <input type="text" name="three" id="three" class="form-control" value="{{ $attendanceData->three ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="four">Four:</label>
                                                                <input type="text" name="four" id="four" class="form-control" value="{{ $attendanceData->four ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="five">Five:</label>
                                                                <input type="text" name="five" id="five" class="form-control" value="{{ $attendanceData->five ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="six">Six:</label>
                                                                <input type="text" name="six" id="six" class="form-control" value="{{ $attendanceData->six ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="seven">Seven:</label>
                                                                <input type="text" name="seven" id="seven" class="form-control" value="{{ $attendanceData->seven ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="eight">Eight:</label>
                                                                <input type="text" name="eight" id="eight" class="form-control" value="{{ $attendanceData->eight ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="nine">Nine:</label>
                                                                <input type="text" name="nine" id="nine" class="form-control" value="{{ $attendanceData->nine ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="ten">Ten:</label>
                                                                <input type="text" name="ten" id="ten" class="form-control" value="{{ $attendanceData->ten ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="eleven">Eleven:</label>
                                                                <input type="text" name="eleven" id="eleven" class="form-control" value="{{ $attendanceData->eleven ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twelve">Twelve:</label>
                                                                <input type="text" name="twelve" id="twelve" class="form-control" value="{{ $attendanceData->twelve ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="thirteen">Thirteen:</label>
                                                                <input type="text" name="thirteen" id="thirteen" class="form-control" value="{{ $attendanceData->thirteen ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="fourteen">Fourteen:</label>
                                                                <input type="text" name="fourteen" id="fourteen" class="form-control" value="{{ $attendanceData->fourteen ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="fifteen">Fifteen:</label>
                                                                <input type="text" name="fifteen" id="fifteen" class="form-control" value="{{ $attendanceData->fifteen ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="sixteen">Sixteen:</label>
                                                                <input type="text" name="sixteen" id="sixteen" class="form-control" value="{{ $attendanceData->sixteen ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="seventeen">Seventeen:</label>
                                                                <input type="text" name="seventeen" id="seventeen" class="form-control" value="{{ $attendanceData->seventeen ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="eighteen">Eighteen:</label>
                                                                <input type="text" name="eighteen" id="eighteen" class="form-control" value="{{ $attendanceData->eighteen ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="nineteen">Nineteen:</label>
                                                                <input type="text" name="ninghteen" id="ninghteen" class="form-control" value="{{ $attendanceData->ninghteen ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twenty">Twenty:</label>
                                                                <input type="text" name="twenty" id="twenty" class="form-control" value="{{ $attendanceData->twenty ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentyone">Twenty-One:</label>
                                                                <input type="text" name="twentyone" id="twentyone" class="form-control" value="{{ $attendanceData->twentyone ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentytwo">Twenty-Two:</label>
                                                                <input type="text" name="twentytwo" id="twentytwo" class="form-control" value="{{ $attendanceData->twentytwo ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentythree">Twenty-Three:</label>
                                                                <input type="text" name="twentythree" id="twentythree" class="form-control" value="{{ $attendanceData->twentythree ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentyfour">Twenty-Four:</label>
                                                                <input type="text" name="twentyfour" id="twentyfour" class="form-control" value="{{ $attendanceData->twentyfour ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentyfive">Twenty-Five:</label>
                                                                <input type="text" name="twentyfive" id="twentyfive" class="form-control" value="{{ $attendanceData->twentyfive ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentysix">Twenty-Six:</label>
                                                                <input type="text" name="twentysix" id="twentysix" class="form-control" value="{{ $attendanceData->twentysix ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentyseven">Twenty-Seven:</label>
                                                                <input type="text" name="twentyseven" id="twentyseven" class="form-control" value="{{ $attendanceData->twentyseven ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentyeight">Twenty-Eight:</label>
                                                                <input type="text" name="twentyeight" id="twentyeight" class="form-control" value="{{ $attendanceData->twentyeight ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="twentynine">Twenty-Nine:</label>
                                                                <input type="text" name="twentynine" id="twentynine" class="form-control" value="{{ $attendanceData->twentynine ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="thirty">Thirty:</label>
                                                                <input type="text" name="thirty" id="thirty" class="form-control" value="{{ $attendanceData->thirty ?? '0' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="thirtyone">Thirty-One:</label>
                                                                <input type="text" name="thirtyone" id="thirtyone" class="form-control" value="{{ $attendanceData->thirtyone ?? '0' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="tab-pane fade" id="pills-intern" role="tabpanel" aria-labelledby="pills-intern-tab">
                    ...
                    <div class="table-responsive">
                        <table id="exampless" class="display nowrap">
                            <thead>
                                <tr>
                                    <th style="display: none;">id</th>
                                    <th>Employee Name</th>
                            ...
                            <tbody>
                                @foreach($attendanceDatasss as $attendanceData)
                              <tr data-toggle="modal" data-target="#updateModal{{$attendanceData->id}}">
                                    <td style="display: none;">{{$attendanceData->id }}</td>
                                    <td>{{ $attendanceData->team_member }} ( {{ $attendanceData->rolename }} )</td>
                                    <td> {{ $attendanceData->employment_status }}</td>
                                    <td>@if($attendanceData->joining_date !=  null){{ date('F d,Y', strtotime($attendanceData->joining_date ??'')) }}@endif</td>
                                    <td> {{ $attendanceData->month }}</td>
                                    <td> {{ $attendanceData->twentysix ??'0' }}</td>
