...
use App\Http\Controllers\PromotionandrejoiningController;
...
Route::group(['middleware' => ['twofactor']], function () {
  ...
  Route::get('/assignmentfile/download/{id}', [AssignmentfolderfileController::class, 'assignmentfileDownload']);
