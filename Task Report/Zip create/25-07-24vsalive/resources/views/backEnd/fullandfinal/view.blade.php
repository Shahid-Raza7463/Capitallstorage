...
@if(Auth::user()->role_id == 18 )
             <li class="breadcrumb-item"><a  onclick="return confirm('Are you sure you want to send reminder this item?');" href="{{ url('fullandfinalreminder/'.$fullandfinal->id)}}"><b>Reminder</b></a></li>
			@endif
                    ...
                    <fieldset class="form-group">
                        ...
                        <table class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                @if($fullandfinal->Assignment_Data_Hanover == 1)
                                <tr>
                                ...
                                @if($fullandfinal->Laptop_Hanover == 1)
                                <tr>
                                    <td><b>Laptop Handover :</b></td>
                                    <td>
                                        <div class="row">
