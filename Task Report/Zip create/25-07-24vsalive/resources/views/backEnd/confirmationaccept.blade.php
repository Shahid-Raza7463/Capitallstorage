        ...
        <div class="form-wrapper m-auto">
            <div class="form-container my-4">
                ...
                <div class="panel">
                    ...
                    @endif
					<div><h6><b>Please Confirm Your Approval</b></h6></div>
			
					<hr>
                  <div style="display: flex">
                        <div class="panel-header text-center" style=" margin-left: 32px;">
                        ...
                        <div class="panel-header text-center" style="margin-left: 11px;">
