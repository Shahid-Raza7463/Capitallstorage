                ...
                <div class="form-container my-4">
                    ...
                    <div class="panel">
                        <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
                            ...
                            <div style="color: #292D32; font-size: 24px; font-family: Inter; font-weight: 500; word-wrap: break-word">Correct Information Required</div>
                        </div>
                        <div style="width: 100%; text-align: center; color: rgba(41, 45, 50, 0.65); font-size: 18px; font-family: Inter; font-weight: 400; word-wrap: break-word">We understand your reason for refusing. Please provide us with the correct information. </div>
                        <div>
