        ...
        <div class="main-content pt-1" id="contentdiv">
            <div style="float: right; margin-right:80px;margin-top: 4px;" class=" align-items-center">
                ...
                @if ($otpsettingstatus == 0)
                    ...
                    <a href="{{ url('/otpskipconfirmationhide?' . 'type=' . $debtors->type . '&&' . 'status=' . 1 . '&&' . 'assignmentgenerate_id=' . $debtors->assignmentgenerate_id . '&&' . 'debitid=' . $debtors->id) }}"
                        class="btn btn-success">
                        Accept
                    </a>
                    <button class="btn btn-danger" onclick="updateConfirmationStatus()">Refuse</button>
                @else
        ...
        function updateConfirmationStatus() {
            ...
            if (status == 0) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/otpskipconfirmationhide') }}",
                    type: 'GET',
                    data: {
                        type: type,
                        status: status,
