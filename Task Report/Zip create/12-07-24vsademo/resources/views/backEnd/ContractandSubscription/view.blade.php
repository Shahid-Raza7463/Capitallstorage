...
<div class="content-header row align-items-center m-0">
    ...
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="btn btn-info ml-2"><a href="{{route('contract.edit', $contractDatas->id ??'')}}" style="color:white;">Edit</a> </li>
			    @endif
			<li> <a class="btn btn-success ml-2" href="{{ url('contract') }}">Back</a></li>
                         ...
                         @endphp
                             ...
                             @endforeach
                                ...
                                <tr>
                                    ...
                                    <td><b>Company Person : </b></td>
                                    <td>{{$contractDatas->contactperson}}</td>
