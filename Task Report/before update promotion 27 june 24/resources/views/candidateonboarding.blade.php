                ...
                <div class="col-12 col-lg-12 col-xl-12">
                    <div class="card shadow-2-strong card-registration" >
                        ...
                        <div class="card-body p-md-5">
                            ...
                            <form method="POST" action="{{ url('candidateonboarding/store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" required name="resume"  class="form-control" value="" />
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phoneno" required  placeholder="Enter Phone No" class="form-control" value="" />
								...
								<div class="row row-sm">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="highestqualification" required  placeholder="Enter Highest Qualification" class="form-control" value="" />

                                        </div>
                                    </div>
									  <div class="col-4">
                                        <div class="form-group">
                                            <label class="font-weight-600">Membership Number ( If CA/CMA/CS )</label>
                                            <input type="number" name="membershipnumber"  placeholder="Enter Membership Number" class="form-control" value="" />
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="nda" required  class="form-control" value="" />
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                ...
                                class="btn btn-success btn"  > <i class="fa fa-file-pdf-o" ></i> Download</a>
                                        </div>
                                    </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label class="font-weight-600"> NDA Intern</label><br>
                                        <a download href="{{ url('backEnd/NDA-intern.pdf')}}"
                                            class="btn btn-success btn"> <i class="fa fa-file-pdf-o"></i>
                                            Download</a>
                                    </div>
                            </div><div class="col-2">
                                    <div class="form-group">
                                        <label class="font-weight-600"> NDA Consultant</label><br>
                                        <a download href="{{ url('backEnd/NDA-Consultant.pdf')}}"
                                            class="btn btn-success btn"> <i class="fa fa-file-pdf-o"></i>
                                            Download</a>
                                    </div>
                            </div>
								 ...
								 <div class="row row-sm">
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label class="font-weight-600">Linkedin Link *</label>
                                                <!--placeholder-->
                                                <input id="linkedin" required type="text" name="linkedin" class="form-control"
                                            value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label class="font-weight-600">Providend Fund Applicable *</label>
                                            <select required name="providend" id="providend" class="form-control">
                                                <!--placeholder-->
                                ...
                                class="btn btn-success btn"  > <i class="fa fa-file-pdf-o" ></i> Download</a>
                                    ...
                                    <div class="col-3" id="pfformupload" style="display: none">
                                        <div class="form-group">
                                            <label class="font-weight-600"> PF Form 11.*</label><br>
                                            <input id="pfformuploads" type="file" name="pfformupload" class="form-control"
                                            value="" />
                                    ...
                                    <div class="col-3" id="uan" style="display: none">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="uans" name="uan"  placeholder="Enter UAN No" class="form-control" value="" />
                                ...
                                <div class="col-3" id="outupload" style="display: none">
                                    <div class="form-group">
                                        <label class="font-weight-600"> Opt Out - PF Declaration </label><br>
                                        <input id="outuploads" type="file" name="outupload" class="form-control" value="" />
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="font-weight-600">Brief About Yourself <span>*</span></label>
                                             <textarea rows="3" name="about" required class="form-control" 
                                                placeholder="Enter Brief About Yourself "></textarea>
                                        </div>
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" required name="bachelor_degree" class="form-control"
                                                value="" />
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="font-weight-600">Membership Certificate (Applicable for
                                                Chartered Accountants)</label>
                                            <input type="file"  name="membership_certificate"
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" required name="pancard" class="form-control" value="" />
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label class="font-weight-600">PAN Card No*</label>
                                            <input type="text" pattern="[A-Za-z]{5}\d{4}[A-Za-z]{1}" required name="pancardno" id="pan" oninvalid="invalidPan()" class="form-control" placeholder="Enter PAN No" maxlength="10" />
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label class="font-weight-600">Aadhar Card No*</label>
                                            <input type="number" required name="adharcardno" id="aadhar" min="100000000000" max="999999999999" oninvalid="invalidAadhar()" class="form-control" placeholder="Enter Adhar No" value="">
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row row-sm">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" required name="residence_proofone"  class="form-control"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" required name="residence_prooftwo"  class="form-control"
                                                value="" />
                                        </div>
                                    </div>
                                ...
                                <div class="row row-sm">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="bankholder_name" class="form-control"
                                                placeholder="Your name as per the Bank Account" value="" />
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required  name="fathercontactno" class="form-control"
                                                placeholder="Enter Father Contact No." value="" />
