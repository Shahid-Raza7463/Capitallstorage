<div class="row row-sm">
    ...
    <div class="col-4">
        <div class="form-group">
            <label class="font-weight-600">Name of Task <span class="tx-danger">*</span></label>
...
<div class="row row-sm">
    <div class="col-12">
        <div class="form-group">
            <label class="font-weight-600">Description of Task <span class="tx-danger">*</span></label>
