...
basically isme ek bugs ye hai ki jab mai accept and refuse button per click karta hu to ek alrt box aata hai jab mai ok
button per click karta hu to mail jata hai aur cancel button per click karta hu to mail nahi jata hai jo ki sah hai ab
mai chahta hu ki jab cancel button per click ho to model box open nahi ho

model box fir bhi open ho raha hai cancel ke click per
...
Azaz~123
you are laravel and javascript expert
you are laravel expert
http://127.0.0.1:8000/viewassignment/BET100051
...
Dear Sir,
We M/s KGS & CO Chartered accountants are the statutory Auditors of M/s ABC for the Financial Year [year]. For the Audit
purpose, we require the confirmation of the outstanding balance of the company in your books of account as on [date].

We request you to confirm the balance at the place provided below and send the duly signed copy of the same to our
address given below. Also share the balance confirmation copy through mail on our mail id office@kgsomani.com
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Reg creditor. Confirmation of Balance as on [date]&nbsp;</p>
<p>Dear Sir,&nbsp;<br>We M/s KGS &amp; CO Chartered accountants are the statutory Auditors of M/s ABC for the Financial
    Year [year]. For the Audit purpose, we require the confirmation of the outstanding balance of the company in your
    books of account as on [date].&nbsp;</p>
<p>We request you to confirm the balance at the place provided below and send the duly signed copy of the same to our
    address given below. Also share the balance confirmation copy through mail on our mail id office@kgsomani.com&nbsp;
</p>
<p>M/s K G Somani &amp; Co. (Chartered Accountants)<br>3rd Floor, Gate no.2, Delite Cinema Building, Asaf Ali
    Road,<br>New Delhi – 110002</p>
<p>An early action would be highly appreciated&nbsp;</p>
<p>Thanking You,&nbsp;</p>
<p>Yours Faithfully&nbsp;</p>
<p>FOR K.G Somani &amp; Co.&nbsp;<br>Chartered Accountants&nbsp;</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Reg Bank. Confirmation of Balance as on [date]&nbsp;</p>
<p>Dear Sir,&nbsp;<br>We M/s KGS &amp; CO Chartered accountants are the statutory Auditors of M/s ABC for the Financial
    Year [year]. For the Audit purpose, we require the confirmation of the outstanding balance of the company in your
    books of account as on [date].&nbsp;</p>
<p>We request you to confirm the balance at the place provided below and send the duly signed copy of the same to our
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background:#37A000">
                        <h5 style="color: white" class="modal-title font-weight-600" id="exampleModalLabel1">Reason
                            For
                            Rejection</h5>
        ...
        <td>
            ...
            <div class="modal fade" id="exampleModal112{{ $loop->index }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background: #218838;">
                            <h5 style="color:white;" class="modal-title font-weight-600" id="exampleModalLabel4">Send
                                Reminder
                                list</h5>
                            <div>
                                <ul>
